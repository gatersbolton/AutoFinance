...
RUNS_DIR = ROOT / "runs"
TEMPLATE_PATH = FINANCE_ROOT / "会计报表.xlsx"
OUTPUT_PATH = RUNS_DIR / "会计报表_项目与大模型对比汇总_20260405.xlsx"
...
COMPARISONS = [
    ComparisonSpec(
        company="泰兴市泰泽实业有限公司",
        project_path=ROOT / "normalized_archive" / "RUN_20260402T161926Z_79bd9692" / "会计报表_填充结果.xlsx",
        llm_path=ROOT / "data" / "会计报表_泰兴市泰泽实业有限公司2022年审计报告_gpt5.4填写.xlsx",
        project_note="基线项目结果（债务人审计报告-2022年）",
        llm_note="采用新命名的泰泽 LLM 文件",
    ),
    ComparisonSpec(
        company="泰兴市长虹现代农业开发有限公司",
        project_path=ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "1.4.2 债务人——三年一期的财务报表（审计报告）.xlsx",
        llm_path=ROOT / "data" / "会计报表_泰兴市长虹现代农业开发有限公司2022年审计报告_gpt5.4填写.xlsx",
        project_note="项目批次 job 01",
    ),
    ComparisonSpec(
        company="盐城平坦住房租赁有限公司",
        project_path=ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "1.4.2.3盐城平坦住房租赁有限公司2022年审计报告.xlsx",
        llm_path=ROOT / "data" / "会计报表_盐城平坦住房租赁有限公司2022年审计报告_gpt5.4填写.xlsx",
        project_note="项目批次 job 02",
    ),
    ComparisonSpec(
        company="泰州新滨江科技发展有限公司",
        project_path=ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "2021年新滨江科技审计报告.xlsx",
        llm_path=ROOT / "data" / "会计报表_泰州新滨江科技发展有限公司2021年审计报告_gpt5.4填写.xlsx",
        project_note="项目批次 job 04",
    ),
    ComparisonSpec(
        company="金湖县润金现代农业发展有限公司",
        project_path=ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "润金2019-2021年度审计报告.xlsx",
        llm_path=ROOT / "data" / "会计报表_金湖县润金现代农业发展有限公司2021年审计报告_gpt5.4填写.xlsx",
        project_note="项目批次 job 05",
    ),
    ComparisonSpec(
        company="淮安市清浦现代农村建设开发有限公司",
        project_path=ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "现代农村2021年审计报告.xlsx",
        llm_path=ROOT / "data" / "会计报表_淮安市清浦现代农村建设开发有限公司2021年审计报告_gpt5.4填写.xlsx",
        project_note="项目批次 job 06",
    ),
    ComparisonSpec(
        company="阜宁县鑫泽源污水处理有限公司",
        project_path=ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "鑫泽源2022年审计报告.xlsx",
        llm_path=ROOT / "data" / "会计报表_阜宁县鑫泽源污水处理有限公司2022年审计报告_gpt5.4填写.xlsx",
...
UNMATCHED = [
    UnmatchedSpec(
        status="项目仅有",
        company="泰兴市中汇贸易有限公司",
        project_file=str(ROOT / "runs" / "20260404_table_only_new_docs" / "results" / "1.4.3债务人2022年审计报告.xlsx"),
        llm_file="",
    ...
    UnmatchedSpec(
        ...
        company="泰泽实业（旧命名文件）",
        project_file="",
        llm_file=str(ROOT / "data" / "会计报表_债务人审计报告-2022年-gpt5.4填写.xlsx"),
        note="与“会计报表_泰兴市泰泽实业有限公司2022年审计报告_gpt5.4填写.xlsx”指向同一公司，主表已采用新命名文件。",
    ),
]
